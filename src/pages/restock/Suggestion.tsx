...
import { Medicine, Supplier, CATEGORY_LABELS } from '../../types';
import { daysToExpiry, getExpiryAlertLevel, formatDate } from '../../utils/date';
...
export default function RestockSuggestion() {
  ...
  const { medicines, suppliers, sales } = useStore();
  ...
  const restockItems = useMemo((): RestockItem[] => {
    ...
    medicines.forEach(medicine => {
      ...
      const expiryLevel = getExpiryAlertLevel(daysRemaining);
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-1 text-sm text-slate-600">
              ...
              <li>• 点击任意一行可展开查看详细的补货原因和供应商联系方式</li>
            </ul>
          </div>
        </div>
      </div>
